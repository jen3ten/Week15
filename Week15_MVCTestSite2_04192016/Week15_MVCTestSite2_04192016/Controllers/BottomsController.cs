...
namespace Week15_MVCTestSite2_04192016.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,Item,Nickname,Season")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,Item,Nickname,Season")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
